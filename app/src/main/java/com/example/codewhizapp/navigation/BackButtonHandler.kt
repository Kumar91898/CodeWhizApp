package com.example.codewhizapp.navigation
...
internal fun ComposableHandler(
    ...
    LaunchedEffect(enabled) {
        ...
        handler.onBackPressed = onBackPressed // Corrected to properly set onBackPressed
    }
}
...
internal fun SystemBackButtonHandler(onBackPressed: () -> Unit){
    CompositionLocalProvider (
        ...
        ComposableHandler(enabled = true, onBackPressed = onBackPressed) // Corrected to properly pass onBackPressed
    }
}