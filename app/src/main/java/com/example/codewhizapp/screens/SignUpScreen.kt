...
import com.example.codewhizapp.components.CheckboxComponent
    ...
    Surface (
        ...
        Column (
            ...
            CheckboxComponent(value = stringResource(id = R.string.terms_and_conditions),
                onTextSelected = {
                    CodeWhizAppRouter.navigateTo(Screen.TermsAndConditionsScreen)
            })
            ...
            ClickableLoginTextComponent(tryingToLogin = true, onTextSelected = {
                CodeWhizAppRouter.navigateTo(Screen.LoginScreen)
            })
